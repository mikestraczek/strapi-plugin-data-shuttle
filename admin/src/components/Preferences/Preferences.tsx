      ...
      <Flex direction="column" alignItems="start" gap={6}>
        <Flex direction="column" alignItems="start" gap={0}>
          <Typography variant="alpha">
            {i18n({
              id: 'plugin.page.homepage.section.preferences.title',
              defaultMessage: 'Default Preferences',
            })}
          </Typography>
          <Typography variant="epsilon">
            {i18n({
              id: 'plugin.page.homepage.section.preferences.description',
              defaultMessage:
                "Configure the default export behavior, so you don't have to set it every time you export.",
            })}
          </Typography>
        </Flex>
          ...
          <Flex direction="column" alignItems="start" gap={4}>
            <Flex justifyContent="space-between">
              <Checkbox
                ...
                onCheckedChange={(value: any) => handleUpdatePreferences('applyFilters', value)}
              >
                <Typography>
                  {i18n({
                    id: 'plugin.export.apply-filters-and-sort',
                    defaultMessage: 'Apply filters and sort to exported data',
                  })}
                </Typography>
              </Checkbox>
            </Flex>
            <Flex direction="column" gap={2}>
              <Typography fontWeight="bold" textColor="neutral800" as="h2">
                {i18n({ id: 'plugin.export.deepness', defaultMessage: 'Deepness' })}
              </Typography>
              <SingleSelect
                ...
                onChange={(value: any) => handleUpdatePreferences('deepness', value)}
              >
